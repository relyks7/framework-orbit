...
Denoting the expected value as $\operatorname{EXP}$ and variance as $\operatorname{VAR}$, we note that

$$
E_u-E_v\odot E_v\approx\operatorname{EXP}(e\odot e)-\operatorname{EXP}(e)\odot\operatorname{EXP}(e)=\operatorname{VAR}(e),
$$

thus, $P\approx 1/(\operatorname{VAR}(e)+\varepsilon)$.
...
$$
\sigma_t=\operatorname{clip}\left(\phi_{\mathrm{mag}}\operatorname{RMS}(a_t),\phi_{\min}(e^{-t/T}),\phi_{\max}\right).
$$

We sample

$$
\eta_t\sim\mathcal{N}(0,\sigma_t^2I_d)
$$
